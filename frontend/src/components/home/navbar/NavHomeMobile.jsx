  ...
  return (
    <section class="flex fixed lg:hidden z-40 bottom-0 left-0 w-full bg-black rounded-t-lg text-sm">
      <div class="container mx-auto flex justify-between items-center p-4 text-gray-400 gap-2">
        ...
        <div onClick={() => handleSetSection("cards")} className="flex flex-col items-center cursor-pointer">
          <BiWindowOpen className="text-xl" />
          <p>Cuentas</p>
        </div>
        ...
        <div onClick={() => handleSetSection("bills")} className="flex flex-col items-center cursor-pointer">
          <BiWindowOpen className="text-xl" />
          <p>Gastos</p>
        </div>
        <div onClick={() => handleSetSection("earnings")} className="flex flex-col items-center cursor-pointer">
          <BiWindowOpen className="text-xl" />
          <p>Ingresos</p>
        </div>
      </div>
