...
export default function NavHome() {
  ...
  return (
    <section className={`${open ? 'w-60' : 'w-20'} bg-black h-full fixed  flex flex-col transition-all duration-300`}>
      <div className="text-white">
        ...
        <div className={`${!open && 'hidden'} bg-gray-300 xl:w-48 xl:h-60 2xl:h-72  md:h-52 rounded-2xl m-5 flex flex-col  text-gray-600 `}>
        ...
        <div className='flex flex-col items-end'>
          <i className='text-2xl cursor-pointer' onClick={() => setOpen(false)}><BsArrowLeft/></i>
