    ...
    <section className="flex flex-col w-full justify-between md:flex-row">
      <div id="leftside" className="flex flex-col w-full gap-9 mt-16 md:w-1/2">
        ...
        <div className="flex gap-6 items-center justify-center">
          <div className="hidden p-1 gap-3 text-mWhite w-52 h-15 text-sm rounded-lg items-center border-solid border-2  border-white cursor-pointer md:flex">
            <FaGooglePlay className="text-mWhite text-5xl" />
            <div className="">
              <p className="font-semibold text-mWhite">Download on the</p>
              <p className=" ">Google Play</p>
            </div>
          </div>
          <div className="hidden p-1 gap-3 text-mWhite w-52 h-15 text-sm rounded-lg items-center border-solid border-2  border-white cursor-pointer md:flex">
            <FaWindows className="text-mWhite text-5xl" />
            <div className="">
              <p className="font-semibold text-mWhite">Download on the</p>
